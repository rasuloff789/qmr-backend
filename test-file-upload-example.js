...
console.log(
	"Use the testFileUpload mutation to test file uploads without the complexity of addTeacher"
);
console.log(
	"Any authenticated user (ROOT, ADMIN, TEACHER) can use this mutation"
);
console.log("\nCurl example:");
