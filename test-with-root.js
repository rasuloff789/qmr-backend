/**
 * Test with root user - create root user first, then test all operations
 */
...
async function testWithRootUser() {
	console.log("🚀 Starting Test with Root User\n");
    ...
    `;
		...
		// Step 3: Test all operations with root user
		console.log("\n3️⃣ Testing all operations with root user...");
