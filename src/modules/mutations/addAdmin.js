...
import { checkUzPhoneInt, checkTelegramUsername, checkUsername, isValidPassword, checkTurkeyPhoneInt, isValidBirthdate } from "../../utils/regex.js";

// Resolver to add a new admin user
const addAdmin = async (_parent, { username, fullname, birthDate, phone, tgUsername, password }) => {
    // Input validation
